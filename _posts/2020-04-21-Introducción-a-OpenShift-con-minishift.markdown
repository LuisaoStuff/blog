...
Para solucionar esto, vamos a crear un **volumen persistente** y cambiando la **estrategia del despliegue** de la aplicación de _rolling_ a **recreate**.
...
Probamos a modificar la página principal:
